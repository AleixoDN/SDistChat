...
public final class Message implements Model {
  ...
  public static final QueryField USER = field("Message", "userMessageId");
  ...
  private final @ModelField(targetType="User") @BelongsTo(targetName = "userMessageId", type = User.class) User user;
